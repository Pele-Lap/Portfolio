...
import EditAbout from "../components/ABoutEd/page";
import EditTrain from "../components/TrainEd/page";
import EditEducation from "../components/EduEd/page";
...
export default function AboutPage() {
  ...
  return (
    ...
    <AdminNavbar></AdminNavbar>
      ...
      <div className="flex flex-row gap-4 z-5">
        <EditAbout></EditAbout>
        <EditTrain></EditTrain>
